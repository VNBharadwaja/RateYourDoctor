...
{
     if(str==""){
                  document.querySelector('#dr').innerHTML="";
                }
else
{
 $.post( 
			...
			<main class="main-content">
				<div class="container">
					<div class="page">
                                                ...
                                                <!-- .row -->
						<!-- .row -->
					             <input type="text" name="t1" style="width: 600px;" placeholder="search using name,ratings,designation,description....."onkeyup="display(this.value)">
						</br>
</br>
<div class="row" id="dr">
